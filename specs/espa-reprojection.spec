...
Summary:	ESPA Reprojection Software

Group:		ESPA
License:	NASA Open Source Agreement
URL:		https://github.com/USGS-EROS/espa-reprojection.git
...
%description
Provides executables for reprojection of ESPA Raw Binary formatted data.
